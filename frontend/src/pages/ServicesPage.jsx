        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mockData.pricing.map((pkg, index) => (
              <Card key={index} className={`relative hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 ${pkg.popular ? 'ring-4 ring-[rgb(34 59 95)] scale-105' : ''}`}>
                {pkg.popular && (
                ...
                <CardContent>
                  ...
                  <Button 
                    className={`w-full mt-6 ${pkg.popular ? 'bg-bis-primary hover:bg-bis-primary/90 text-white' : 'border-bis-primary text-bis-primary hover:bg-bis-primary hover:text-white'}`}
