        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-bis-primary mb-2">{allPosts.length}+</div>
              <div className="text-sm lg:text-base text-gray-300">Bài viết chuyên sâu</div>
            </div>
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-bis-primary mb-2">50k+</div>
            ...
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-bis-primary mb-2">Weekly</div>
