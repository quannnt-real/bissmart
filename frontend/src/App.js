      ...
      <BrowserRouter>
        ...
        <main>
          <Routes>
            ...
            <Route path="/lien-he" element={<div className="container mx-auto px-4 py-16 text-center"><h1 className="text-2xl font-bold text-gray-900">Trang Liên hệ</h1><p className="text-gray-600 mt-4">Đang phát triển...</p></div>} />
          </Routes>
        </main>
        <Footer />
      </BrowserRouter>
